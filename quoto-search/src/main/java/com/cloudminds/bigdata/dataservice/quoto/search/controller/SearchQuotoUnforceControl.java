...
import com.cloudminds.bigdata.dataservice.quoto.search.redis.RedisUtil;
import com.cloudminds.bigdata.dataservice.quoto.search.service.SaveAccessHistory;
...
@RestController
@RequestMapping("/search/unForce/quoto")
public class SearchQuotoUnforceControl extends APIJSONController {
	@Autowired
