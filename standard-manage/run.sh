...
run_service() {
    ...
    "standard-manage")
        java -jar -Duser.timezone=Asia/Shanghai /dataservice/standard-manage/bigdata-dataservice-standard-manage.jar --spring.profiles.active=${2} --add-exports java.naming/com.sun.jndi.ldap=spring.ldap.core
        ;;
