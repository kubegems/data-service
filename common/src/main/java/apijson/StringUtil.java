...
//第二版sql处理
	...
	public static String columnReplace(String column, String schema, String table) {
		if (AbstractSQLConfig.tableColumnMap.get(schema + "." + table + "_aliasColumn") != null
				&& AbstractSQLConfig.tableColumnMap.get(schema + "." + table + "_aliasColumn").containsKey(column)) {
			column = AbstractSQLConfig.tableColumnMap.get(schema + "." + table + "_aliasColumn").get(column);
		}
		return column;
	}
